...
* [Daniel Auener](http://www.danielauener.com/woocommerce-with-thousands-of-products-workarounds-for-slow-admin-panel/)
...
1. Upload to the `/wp-content/plugins/disable-wc-status-littlebizzy` directory
2. Activate via WP Admin > Plugins
3. Verify WoooCommerce Status widget is gone (WP Admin Dashboard)

== Frequently Asked Questions ==

= How can I change this plugin's settings? =

There is no settings page to ensure top performance and security.
